...
| M4-T4-UI | 重构 Wi-Fi Direct Test 页面 | Android Dev / Designer | 待办池 | M4-T4, M2-T4 | 页面符合设计系统；状态清晰、操作分区、日志可折叠 | 由用户反馈插入：当前界面信息过载、交互不佳 |
| M4-T5 | 手动网络配置入口 | Android Dev | 待办池 | M3-T3 | 可手动选择 GO/Client | |
