...
| **M4-T5-VERIFY** | **M4-T5 真机网络验证** | **`pro-android-system-test`** | **本周进行** | **2026-07-07** | **M4-T5, M4-T5-FIX** | **一加/华为 GO/Client 两种模式通话均正常，故障提示正确** | TC-1（一加 GO + 华为 Client）已复测通过；TC-2、TC-3 待执行；见 `docs/M4-T5_VERIFICATION.md` |
